...
import fittrack_mock from '../assets/images/ftbanner1.webp';
import mtbanner1 from '../assets/images/mtbanner1.webp';
import grapho_mock from '../assets/images/gbanner1.webp';
import biteiq_mock from '../assets/images/bibanner1.webp';
...
const projects = [
    {
        id: 'biteiq',
        title: 'BiteIQ',
        description: '🤖 AI-powered food recognition and nutrition insights app built with Flutter, BLoC, and Firebase.',
        image: biteiq_mock,
    ...
    },
    {
        ...
        image: mtbanner1,
        stack: ['Flutter', 'Bloc', 'Firebase', 'Stripe', 'FCM'],
    },
                ...
                {projects.map((project) => (
                    <div className="project" key={project.id}>
                        <Link to={`/project/${project.id}`} aria-label={`View ${project.title} project`}>
                            <img src={project.image} className="project-card-img" alt={project.title} loading="lazy" />
                        </Link>
